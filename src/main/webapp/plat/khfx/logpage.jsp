  ...
  <tr>
    <td width="100%">
      <table border="0" cellpadding="0" cellspacing="0" width="486" align=center>
        <tr>
          <td width="100%"><img border="0" src="<c:url value="/plat/yjh/img/a04.gif"/>" width="486" height="88"></td>
        </tr>
        <tr>
          <td width="100%" background="<c:url value="/plat/yjh/img/a05.gif"/>" height="150" valign="top">
