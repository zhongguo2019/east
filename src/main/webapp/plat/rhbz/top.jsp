...
<script type="text/javascript" src="<c:url value='/plat/rhbz/pngfix.js'/>"></script>

<link href="<c:url value='/plat/rhbz/ty.css'/>" rel="stylesheet" type="text/css" />
<link href="<c:url value='/plat/rhbz/krm-hzjr.css'/>" rel="stylesheet" type="text/css" />
				  ...
				  <div class="hzjr_top">
				    <div class="hzjr_top2">
				      <div class="hzjr_top2_r">
				      	<a href="<c:url value='/template/tianjin/fmDialog.jsp'/>" target="mainFrame" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','krm-hzjr/hzjr_j02-.jpg',1)">
				      		<img src="<c:url value='/plat/rhbz/krm-hzjr/hzjr_j02.jpg'/>" alt="<fmt:message key="top.modify.pass"/>" name="Image1" width="30" height="34" border="0" id="Image1" />
				      	</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				      	<a href="javascript:logOut();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','krm-hzjr/hzjr_j03-.jpg',1)">
				      		<img src="<c:url value='/plat/rhbz/krm-hzjr/hzjr_j03.jpg'/>" alt="<fmt:message key="user.logout"/>" name="Image2" width="22" height="34" border="0" id="Image2" />
				      	</a>
				      </div>
