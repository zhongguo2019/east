<!-- /ps/model/datafill/editOneData2.jsp -->
			...
			<td width="100%"  valign="top"><br>
				...
				value="<c:out value='${levelFlag}'/>" />
					<table id="budgetTbl" width="99%" align="center" cellpadding="1"
						...
						<thead>
							<tr height="40px">
								<td align="center" style="width:60px;" nowrap class="color"><fmt:message
											...
											<c:set
												...
												<c:if test="${reportTarget.fieldType==2}">
													<input type="hidden"
														name="<c:out value="${itemDataKey}"/>_id" align="left"
														value="<c:out value="${itemSort.key}"/>" />
														<input id="<c:out value="${itemDataKey}"/>"  onClick="WdatePicker();"
														name="<c:out value="${itemDataKey}"/>"   <c:if test="${ruleMap[itemDataKey]!=null}"> dataType="<c:out  value='${itemvalueIndex}' />"  labelText="<c:out value='${reportTarget.targetName}'/>" </c:if>   
