...
$(document).ready(function(){
 ...
 <script type="text/javascript">
	    //    window.parent.document.getElementById("ppppp").value= "<fmt:message key="view.kettle.upload"/>";  
</script>
		...
		<input id="message" value="<c:out value='${message}'/>" type="hidden" />
						...
						<tr align="center">
							<td class="TdBgColor1" colspan="2" align="center">
							  <a id = "btnMovePrevious" name = "btnMovePrevious" href="#" class="easyui-linkbutton"   style="width:80; height: 20;text-decoration:none;"  onclick = "fanhui();"><fmt:message key="button.back"/></a>&nbsp;
			<a id = "btnMoveNext" name = "btnMoveNext" href="#" class="easyui-linkbutton"    style="width:80; height: 20;text-decoration:none; "   onclick = "xlsInit();"><fmt:message key="standard.dataFill.importData"/></a>&nbsp;
