...
function  listReportRule(displaypage){
	$("#urlreasons").val('');
 	var df=document.reportFormatForm;	
	df.action='<c:out value="${hostPrefix}" /><c:url value="/repFileAction.do" />?method=listRepJhgz&d-5480-p='+displaypage;
	df.submit();
}
...
<body >
					...
					<table class="TdBGColor1" width="80%"   align="center" style="margin-top: 3%">
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.jhgzxh"/>:
							 </td>
							 <td align="left" >
						         <c:out value='${codeRepJhgz2.jhgz}'/> 
						    </td>
						</tr>
						<tr>
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.jhzd"/>:
							 </td>
							 <td align="left" >
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.jhgzms"/>:
							 </td>
							 <td align="left" >
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.cwts"/>:
							 </td>
							 <td align="left"  >
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.zl"/>:
							 </td>
							 <td align="left" >
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.cwlv"/>:
							 </td>
							 <td align="left" >
						...
						<tr>
						     <td    class="TdBGColor1" align="right"><fmt:message key="view.cwyyjs"/>:
							 </td>
							 <td align="left" >
