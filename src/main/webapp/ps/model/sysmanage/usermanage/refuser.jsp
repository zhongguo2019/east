...
window.parent.document.getElementById("ppppp").value= "<fmt:message key="usermanage.sysadmin.menu"/><fmt:message key="navigation.arrowhead"/><fmt:message key="usermanage.sysadmin.menu.resetpassword"/>";
</script>
...
<html:hidden property="pkid" value="<%=tt %>" />           
			...
			<br>
			    ...
			    <tr>
			        ...
			        <td class="TdBGColor2">
			            <input maxlength="10"  type="password" name="repassword" style="width:150;" value="" onchange="checkpsd(this);" />			            
			        </td>
			    </tr>
