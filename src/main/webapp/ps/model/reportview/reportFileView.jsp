...
<c:if test="${canEdit == '1'}">
window.parent.document.getElementById("ppppp").value= "<fmt:message	key="navigation.rportfile.edit" />";
</c:if>
<c:if test="${canEdit == '0'}">
window.parent.document.getElementById("ppppp").value="<fmt:message key="navigation.rportfile.view" />";
</c:if>
</script>
</head>
