...
(function($){
	...
	$.extend({
		...
		reg : {
			...
			_1002itemvalue4: /^[\\u4E00-\\u9FA5\\uF900-\\uFA2D]+$/,
			_1002itemvalue5:/^[1-9]([0-9]{14}|[0-9]{17})$/,
			_1002itemvalue6:/ /,
			_68itemvalue1:/ /,
			_68itemvalue2:/[@#\$%\^&\*]+/,
			_68itemvalue3:/^\d{8}$/,
			_68itemvalue4:/^[1-9]([0-9]{14}|[0-9]{17})$/,  
			_68itemvalue5:/ /,
			_68itemvalue6:/ /,
			_68itemvalue7:/ /,
			_68itemvalue8:/ /,
		...
		msg_zh : {
			...
			EmailStr : "不是有效的邮箱地址",
			illegalStr:"包含非法字符",
			_1002itemvalue4Str:"含有非法字符",
			_1002itemvalue5Str:"身份证信息错误",
			_1002itemvalue6Str:"",
			_67itemvalue2Str:"含有非法字符" ,
				_68itemvalue1Str:"只能为8位数字" ,
				_68itemvalue2Str:"包含非法字符" ,
				_68itemvalue4Str:"只能为9位数字" ,
				_68itemvalue5Str:"",
				_68itemvalue6Str:"",
				_68itemvalue7Str:"",
				_68itemvalue8Str:"",
