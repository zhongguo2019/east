...
(function($){
	...
	$.extend({
		...
		reg : {
			...
			_1022itemvalue1: / /,	//内部机构号
			_1022itemvalue2: /.+/,	//客户代码
			_1022itemvalue3: /.+/,	//护照号码	
			_1022itemvalue4: /^[\s]{0,}[1-9]{1}[0-9]{3}[0-1]{1}[1-9]{1}[0-2]{1}[0-9]{1}$/,	//签发日期
			_1022itemvalue5: /^[\s]{0,}[1-9]{1}[0-9]{3}[0-1]{1}[1-9]{1}[0-2]{1}[0-9]{1}$/	//到期日期
		...
		msg_zh : {
			...
			illegalStr:"包含非法字符",
			_1022itemvalue1Str:"",
			_1022itemvalue2Str:"不能为空",
			_1022itemvalue3Str:"不能为空",
			_1022itemvalue4Str:"8位字符",
			_1022itemvalue5Str:"8位字符"
