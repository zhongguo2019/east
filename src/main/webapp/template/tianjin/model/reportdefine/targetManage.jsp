    ...
    <td width="100%" background="<c:url value="${imgPath}/f02.gif"/>" height="36">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <td>
				<p style="margin-top: 3"><font class=b><b><fmt:message key="navigation.dataFill.buluTemplate"/></b></font></p>
          </td>
		  <td  ></td> 
        </tr>
      </table>
...
<tr>
<td class="TdBGColor1">
<form action="<c:url value='reportTargetAction.do?method=saveTemplateTargets'></c:url>" method="post" name="targetForm" id="targetForm">
...
if((reportId1==""||reportId1 == null) && (vReportId !=""||vReportId != null)){
	...
	df.action="reportTargetAction.do?method=listTarget&openmode="+tg;
