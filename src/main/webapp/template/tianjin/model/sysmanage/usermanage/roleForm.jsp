...
<form name="roleForm" id="roleForm" action="userRoleAction.do?method=addUserRole" method="post">
 ...
 --%>		</tr>
	...
	<c:if test="${flag == '2'}">
		<tr style="height:10">
	    	...
	    	<input type="hidden" name="menuId" value=""/>
			<td class="TdBGColor1" width="12%" align="right"><fmt:message key="role.type"/></td>
			<td class="TdBGColor2" width="40%"><input type="text" name="roleType" maxlength="1" value="<c:out value="${roleForm.roleType}"/>" readOnly="true"  id="roleType2"/></td>
			<td class="TdBGColor1" width="12%" align="right" ><fmt:message key="role.name"/></td>
			<td class="TdBGColor2" width="40%"><input type="text" name="name" maxlength="30" value="<c:out value="${roleForm.name}"/>" /></td>
		</tr>			
		<tr height="10">
			<td class="TdBGColor1" width="12%" align="right"><fmt:message key="role.description"/></td>
