        ...
        <tr>
          ...
          <td>
							<p style="margin-top: 3">
								<font class=b><b><fmt:message key="welcome.fileListTitle"/></b></font>
							</p>
						</td>
						<td></td>
					</tr>
			...
			<td width="100%" bgcolor="#EEEEEE" valign="top">
				<table border="0" width="98%" align="left" cellSpacing=0 cellPadding=0>
					<tr>
						...
						<!-- 
							<a href="dataFill.do?method=getReportGuideDetailed&organId=<c:out value="${organId}" />&reportId=<c:out value="${reportId}" />&targetTable=<c:out value="${targetTable}" />" style="color:#990000;un"><strong><fmt:message key="button.back"/></strong></a></td>
					 -->
					 <a href="dataFill.do?method=getReportGuide&levelFlag=1" style="color:#990000;un"><strong><fmt:message key="button.back"/></strong></a></td>
					</tr>
					<tr>
						<td align="center">
