		...
		<tr>
			<td width="100%" bgcolor="#EEEEEE" valign="top">
				<table border="0" width="98%" align="left" cellSpacing=0 cellPadding=0>
					...
					<tr>
					   <td >
					      &nbsp;&nbsp;&nbsp;<input type="button" value="<fmt:message key="view.sjtbtj"/>"  onclick="reportmoves(); return false;"/>
					   </td>
					</tr>
					<tr>
						<td align="center">
	...
	$.ajax({
		...
		error : function(e){
			alert(e);
                ...
                <div id="check" style="filter: alpha(opacity = 80);  position: absolute; top: 60; left:500 ; z-index: 10; width: 200; height: 74">
