...
function resetdata(obj,reportda,resulttablename,dataId,repid) {
 ...
 function buttongjcx(organId,levelFlag){
	   var zhi1=$("#zhi").val();
	 //  var url = "dataFill.do?method=getDataDetailgjcx&levelview=1&zhi="+zhi1+"&organId="+organId+"&levelFlag="+levelFlag ;
...
<script src="<c:url value='/ps/framework/common/jqueryTab/jquery-1.4.1.min.js'/>" type="text/javascript" />
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<td width="100%" bgcolor="#EEEEEE" valign="top">
				<table border="0" width="98%" align="left" cellSpacing=0 cellPadding=0>
					<tr>
						...
						<c:if test="${lxview=='1'}" >
							<form name="dataMergeForm" action="flexiblequery.do?method=getDataDetail&levelview=1" method="post">
						</c:if>
								...
								<table width="100%" border="0" align="left" cellSpacing="0"
									...
									<tr>
										...
										<td class="TdBGColor1" width="50px"><input id="reportDate"
											name="reportDate" type="text"
								...
								<c:if test="${lxview=='1'}" >
									<tr>
								    	...
								    	<td class="TdBGColor1" width="50px">
										 ...
										 <td width="80" align="left" nowrap class="TdBGColor1">
										    <input type="text" style="height: 19;" id="zhi" value='<c:out value="${zhi}"></c:out>' name="zhi" />
										 </td>
										 <td style="width:40px;" align="left" nowrap class="TdBGColor1"
											align="right">
		...
		<table width="99%" align="center" cellpadding="1" cellspacing="1"
						...
						<c:if test="${lxview=='1'}" >
						    <tr align="left">
								<td align="left" valign="top" class="TdBGColor2"><fmt:message key="view.dqd"/> <c:out
									...
									href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=1&levelview=1"><fmt:message key="chartpage.navigation.homepage"/></a>
									<c:if test="${page.pageNo>1 }">
										<a
											href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${page.pageNo-1 }'/>&levelview=1"><fmt:message key="view.syy"/></a>
									</c:if> 
  					...
  					[ <c:out value="${num }" /> ]
											...
											<c:otherwise>
  					[ <a href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${num}'/>&levelview=1"><c:out
														value="${num }" /> </a> ]
  				</c:otherwise>
										</c:choose>
									</c:forEach> <a
									href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${totalPage}'/>&levelview=1"><fmt:message key="view.wy"/></a>
									<c:if test="${page.pageNo<totalPage}">
										<a
											href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${page.pageNo+1 }'/>&levelview=1"><fmt:message key="view.xyy"/></a>
						...
						<c:if test="${lxview!='1'}" >
						   <tr align="left">
								<td align="left" valign="top" class="TdBGColor2"><fmt:message key="view.dqd"/>  <c:out value="${page.pageNo}" /><fmt:message key="view.ye"/>  <a
									href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=1"><fmt:message key="chartpage.navigation.homepage"/></a>
									<c:if test="${page.pageNo>1 }">
										<a
											href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${page.pageNo-1 }'/>"><fmt:message key="view.syy"/></a>
									</c:if> 
  					...
  					[ <c:out value="${num }" /> ]
											...
											<c:otherwise>
  					[ <a href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${num}'/>"><c:out
														value="${num }" /> </a> ]
  				</c:otherwise>
										</c:choose>
									</c:forEach> <a
									href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${totalPage}'/>"><fmt:message key="view.wy" /></a>
									<c:if test="${page.pageNo<totalPage}">
										<a
											href="flexiblequery.do?method=getDataDetail&openmode=_self&cstatus=<c:out value='${lxhcstatus}'/>&reportDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&levelFlag=<c:out value='${levelFlag}'/>&page=<c:out value='${page.pageNo+1 }'/>"><fmt:message key="view.xyy" /></a>
									</c:if> <fmt:message key="view.zg"/><c:out value="${totalPage}" /><fmt:message key="view.ye"/><fmt:message key="view.zg"/> <c:out
										value="${page.totalRecord }" /> <fmt:message key="view.jls"/> <fmt:message key="view.tzz"/> <input id="pageNo"
									type="text" style="width: 40px;" /> <fmt:message key="view.ye"/><input type="button"
									value="GO" onclick="go()" class="btn" />&nbsp;&nbsp;&nbsp;&nbsp;
...
function changeOrg(){
    var oDate = document.dataMergeForm.date;
...
function changeRep(){
    var oDate = document.dataMergeForm.date;
	var vDate = oDate.value;
	var oOrganId = document.dataMergeForm.organ;
...
function go() {
	...
	window.location.href = "flexiblequery.do?method=getDataDetail&openmode=_self&levelFlag=<c:out value='${levelFlag}'/>&dataDate=<c:out value='${dataDate}'/>&reportId=<c:out value='${reportId}'/>&organId=<c:out value='${organId}'/>&page=" + pageNo;
}
</script>