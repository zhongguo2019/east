...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		height="100%">
		<tr>
			<td width="100%" background="<c:url value="${imgPath}/f02.gif"/>"
				height="36">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="19"><img border="0"
							src="<c:url value="${imgPath}/f01.gif"/>" width="19" height="36"></td>
						<td width="42"><img border="0"
							src="<c:url value="${imgPath}/f03.gif"/>" height="16"></td>
						<td>
		...
		<tr>
			<td width="100%" background="<c:url value="/theme/default/skin_01/imgs/f05.gif"/>"
				valign="top"><br> <br> 
				<html:form action="xlsInit"
					method="post" enctype="multipart/form-data" styleId="xlsInitForm">
					<table width="550" border="0" align="center" cellSpacing="1"
						...
						<tr align="center">
							<td class="TdBgColor1" colspan="2" align="center"><input
								name="method.xlsInit" type="button"
	...
	<script type="text/javascript">
		...
		function xlsInit() {
			...
			//if (validateFile('xlsx', oData)) {
				//if (validateFile('xml', oConfig)) {
				//	showMessage();
					document.xlsInitForm.action = "<c:out value="${hostPrefix}"/>/<c:out value="${systemName}"/>/xlsInit.do?method=uploadExcelYJH&xlsfilename="+xlsfilename;
