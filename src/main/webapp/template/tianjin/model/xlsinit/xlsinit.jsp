...
<table WIDTH='100%' BORDER='0' CELLSPACING='0' CELLPADDING='0' > <tr > <td width='50%' bgcolor='#104A7B'> <table WIDTH='100%' height='70' BORDER='0' CELLSPACING='2' CELLPADDING='0'> <tr> <td bgcolor='#EEEEEE' align='center'> <nobr>&nbsp;&nbsp;&nbsp;<fmt:message key="sysinit.button.init"/>&nbsp;&nbsp;&nbsp; </td> </tr> </table> </td> </tr> </table>
</div>
    ...
    <td width="100%" background="<c:url value="${imgPath}/f02.gif"/>" height="36">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <td>
            <p style="margin-top: 3"><font class=b><b><fmt:message key="reportdefine"/><fmt:message key="navigation.arrowhead"/><fmt:message key="usermanage.sysadmin.xlsinit"/></b></font></p>                         
          </td>
		  <td></td> 
        </tr>
      </table>
