    ...
    <td width="100%" background="<c:url value="${imgPath}/f02.gif"/>" height="36">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <td> 
				<p style="margin-top: 3"><font class=b><b><fmt:message key="view.ywzbgzpi"/> >> <fmt:message key="view.jbgzpz"/></b></font></p>
          </td>
		  <td></td> 
        </tr>
      </table>
...
function editrule(){
	...
	df.action='<c:out value="${hostPrefix}" /><c:url value="/reportrule.do" />?method=editBasicRule';
	df.submit();
}
function viewrule(){
	var df=document.reportViewForm;	 
