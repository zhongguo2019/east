...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0"  height="180"  onload="forbiddon();"  >
...
<form name="menuForm" action="" method="post"> 
              <tr>
                ...
                <td bgcolor="#407CCA"  valign="top" >         
		         <select style="width:163px;font:b" name="organTree" id="organTree" onChange="javascript:changeOrganTree(this);">
		          </select>
                </td>
              </tr>
<div class="hzjr_sj "  id="ss">
  <div class="hzjr_sj_l" >
    <% 
    	int i=1;
    	String tdid = "tb"+i;
