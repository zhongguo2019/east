...
public class StrdReporeWheconditionDAOHibernate extends BaseDAOHibernate implements StrdReporeWheconditionDAO{

	@Override
	public List getStrdreporeWhecondition(Long tempid) {
		String hql = "from  StrdReportWhecondition t where t.tempid = " + tempid
