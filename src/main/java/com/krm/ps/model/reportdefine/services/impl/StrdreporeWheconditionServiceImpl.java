...
public class StrdreporeWheconditionServiceImpl implements
		StrdReporeWheconditionService {
	...
	public void saveStrdreporeWhecondition(
		...
		this.strdReporeWheconditionDAO
				.saveStrdreporeWhecondition(strdReportWhecondition);

	}

	@Override
	public String getStrdreporeWhecondition(Long tempid, Long modelid) {
		StrdReportWhecondition reportWhecondition = this.strdReporeWheconditionDAO
				.getStrdreporeWhecondition(tempid, modelid);
	...
	public void delStrdreporeWhecondition(Long tempid, Long modelid) {
		this.strdReporeWheconditionDAO.delStrdreporeWhecondition(tempid,
				modelid);
